...
from app.services.exercises_helpers import (
    _select_words,
    _serialize_item_for_client,
    _is_proper_noun,
    _generate_collocations,
    _grader_user_prompt,
    _coerce_grade,
    _grade_via_openai,
)
...
# ─── Word browse (legacy / setup preview, word selection imported from exercises_helpers) ──
