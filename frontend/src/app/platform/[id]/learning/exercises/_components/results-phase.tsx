...
import { formatUsageScore, type ExerciseGradeResult, type ExerciseWord } from '@/lib/hooks/use-exercises'
...
export function ResultsPhase({
    results, words, sentences, correctCount, accuracy, onAgain, onDone,
}: ResultsPhaseProps) {
